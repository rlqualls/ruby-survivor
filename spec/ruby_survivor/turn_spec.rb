...
describe RubySurvivor::Turn do
  describe "with actions" do
    before(:each) do
      @turn = RubySurvivor::Turn.new({:walk! => nil, :attack! => nil})
    end
