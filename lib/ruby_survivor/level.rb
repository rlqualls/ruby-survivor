module RubySurvivor
  class Level
    ...
    attr_accessor :description, :tip, :clue, :survivor, :floor, :time_bonus, :ace_score
    ...
    def tally_points
      ...
      UI.puts "Level Score: #{survivor.score}"
      ...
      if @profile.epic?
        ...
        @profile.score += score
        @profile.abilities = survivor.abilities.keys
      end
    end
    ...
    def clear_bonus
      ((survivor.score + time_bonus)*0.2).round
    end
    ...
    def setup_survivor(survivor)
      @survivor = survivor
      @survivor.add_abilities(*profile.abilities)
      @survivor.name = profile.survivor_name
    end
  end
end
